function [h_filename] = real_space_sym_5band(filename,tar_folder,tar_theta,side,rewan)
    ...
    if (rewan == 0)
        ...
        h_filename = [tar_folder '/hmat_5band_' side_str '_' strrep(num2str(tar_theta,'%.2f'),'.','p') '_RS.dat'];
    ...
    elseif (rewan == 1)
        ...
        h_filename = [tar_folder '/hmat_5band_' side_str '_' strrep(num2str(tar_theta,'%.2f'),'.','p') '_rewan_RS.dat'];
        H = load(filename);
