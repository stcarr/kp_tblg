function [wf_filename] = eightWAN_WF_modifyU(h_in_filename,wf_in_filename,modify_U_filename,tar_theta,tar_folder,numk)
    % the twist angle converted into radian
    % this MacDonald effective theory has magic angle ~1.1 degree
    
    wf_filename = [tar_folder '/eightWAN_modifyU_wf_' strrep(num2str(tar_theta,'%.2f'),'.','p') '_' num2str(numk) 'k.mat'];
    ...
    % Should be same phase as in real_space_sym.m "Rephase WFs" section
