function [dos_sweep, ldos_sweep, E_list] = interp_kp_ldos(theta_list, sweep_vals, sweep_weights, sweep_kpts)
    ...
    for t_idx = 1:length(tar_theta_list)
        ...
        allweights1 = (sweep_weights{t_idx}); % nr x tot_dim x nk
        allweights1 = squeeze(mean(allweights1,1));
        ...
        ldos_sweep{t_idx} = dos_rescale*ldos*size(ldos,2); % ldos in same units as dos
